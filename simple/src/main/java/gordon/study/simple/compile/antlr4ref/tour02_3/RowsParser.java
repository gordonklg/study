// Generated from C:/study/codebase/github/gordonklg/study/simple/src/main/java/gordon/study/simple/compile/antlr4ref/tour02_3\Rows.g4 by ANTLR 4.8
		...
		try {
			...
			do {
				...
				((RowContext)_localctx).STUFF = match(STUFF);
				          ...
				          _localctx.i++; // _localctx.i++;
				          if ( _localctx.i == col ) System.out.println((((RowContext)_localctx).STUFF!=null?((RowContext)_localctx).STUFF.getText():null)); // if ( _localctx.i == col ) System.out.println((((RowContext)_localctx).STUFF!=null?((RowContext)_localctx).STUFF.getText():null));
