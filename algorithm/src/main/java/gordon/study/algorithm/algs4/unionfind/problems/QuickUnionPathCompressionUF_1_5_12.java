...
package gordon.study.algorithm.algs4.unionfind.problems;
 ...
 *  @author Kevin Wayne
 */
public class QuickUnionPathCompressionUF_1_5_12 {
     ...
     */
    public QuickUnionPathCompressionUF_1_5_12(int n) {
        parent = new int[n];
        count = n;
        for (int i = 0; i < n; i++) {
            parent[i] = i;
    ...
    public static void main(String[] args) {
        int n = StdIn.readInt();
        QuickUnionPathCompressionUF_1_5_12 uf = new QuickUnionPathCompressionUF_1_5_12(n);
        while (!StdIn.isEmpty()) {
            int p = StdIn.readInt();
            int q = StdIn.readInt();
