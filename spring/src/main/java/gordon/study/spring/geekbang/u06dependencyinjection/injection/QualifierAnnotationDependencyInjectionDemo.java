...
import gordon.study.spring.geekbang.u06dependencyinjection.injection.annotation.UserGroup;
...
public class QualifierAnnotationDependencyInjectionDemo {
    ...
    // user1 -> @Qualifier
    // user2 -> @Qualifier
    // user3 -> @UserGroup -> @Qualifier
    // user4 -> @UserGroup -> @Qualifier

    @Autowired
    private Collection<User> allUsers; // 6 Beans
